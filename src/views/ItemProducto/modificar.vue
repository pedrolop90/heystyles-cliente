                ...
                <template>
                    ...
                    <form role="form">
                        ...
                        <div class="text-center py-1">
                            <base-button @click="guardarCambios()" type="primary" class="my-6 fa fa-check" style="min-width: 150px; margin: 3px !important">
                                Guardar Cambios
                            </base-button>
                        </div>
                    </form>
...
export default {
    ...
    data () {
        return {
            ...
            unidadesMedida: this.unidadesMedidaProp,
            nombre : 'holaq'
        }
    },
    computed: {
    ...
    methods: {
        guardarCambios () {
            ...
            this.$emit('modificarItem', producto)
            this.limpiar()
            this.activo = false
        },
        limpiar () {
